    ...
    <div class="article-admin">
        <b-form>
            ...
            <b-form-group label="Descrição:" label-for="article-description">
                <b-form-input id="article-description" type="text" v-model="article.description" placeholder="Informe a Descrição do Artigo..." required :readonly="mode === 'remove'" />
            </b-form-group>

            <b-form-group v-if="mode ==='save'" label="Imagem (URL):" label-for="article-imageUrl">
                <b-form-input id="article-imageUrl" type="text" v-model="article.imageUrl" placeholder="Informe a URL da Imagem..." required :readonly="mode === 'remove'" />
            </b-form-group>
